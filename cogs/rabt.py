...
QUESTIONS = [
    ...
    ("عاصمة الكويت", "الكويت"), ("عاصمة الإمارات", "أبوظبي"), ("عاصمة السعودية", "الرياض"),
    ("عاصمة عمان", "مسقط"), ("عاصمة البحرين", "المنامة"), ("عاصمة قطر", "الدوحة"),
    ("عاصمة العراق", "بغداد"), ("عاصمة سوريا", "دمشق"), ("عاصمة لبنان", "بيروت"),
    ("عاصمة ليبيا", "طرابلس"), ("عاصمة تونس", "تونس"), ("عاصمة الأردن", "عمان"),
    ("عاصمة المغرب", "الرباط"), ("عاصمة الجزائر", "الجزائر"), ("عاصمة السودان", "الخرطوم"),
    ("عاصمة الصين", "بكين"), ("عاصمة روسيا", "موسكو"), ("عاصمة الهند", "نيودلهي"),
    ("عاصمة ألمانيا", "برلين"), ("عاصمة إيطاليا", "روما"), ("عاصمة إسبانيا", "مدريد"),
    ("أطول نهر في العالم", "النيل"), ("أعلى جبل في العالم", "إيفرست"),
    ("أكبر دولة في العالم", "روسيا"), ("أكبر محيط في العالم", "المحيط الهادئ"),
    ...
    ("أقرب كوكب للشمس", "عطارد"), ("كوكب الحلقات", "زحل"),
    ("عدد أشهر السنة", "12"), ("عدد أيام السنة", "365"),
    ("عدد ساعات اليوم", "24"), ("عدد أيام الأسبوع", "7"),
